...
const CharacterDetail = ({ character }: CharacterDetailProps) => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-brainrot-light rounded-lg p-6">
            <h2 className="text-xl font-bold text-brainrot-turquoise mb-4">Biografía</h2>
            <p className="text-gray-300">{character.biography || character.description}</p>
          </div>
          
          {character.abilities && character.abilities.length > 0 && (
            <div className="bg-brainrot-light rounded-lg p-6">
              <h2 className="text-xl font-bold text-brainrot-turquoise mb-4">Habilidades</h2>
          ...
          {character.phrase && (
            <div className="bg-brainrot-light rounded-lg p-6">
              <h2 className="text-xl font-bold text-brainrot-turquoise mb-4">Frase característica</h2>
          ...
          {character.appearances && character.appearances.length > 0 && (
            <div className="bg-brainrot-light rounded-lg p-6">
              <h2 className="text-xl font-bold text-brainrot-turquoise mb-4">Apariciones notables</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
        <div className="bg-brainrot-light rounded-lg p-6">
          <h2 className="text-xl font-bold text-brainrot-turquoise mb-6">Estadísticas básicas</h2>
        ...
        <div className="bg-brainrot-light rounded-lg p-6">
          <h2 className="text-xl font-bold text-brainrot-turquoise mb-6">Relaciones</h2>
          
          <div className="mb-6">
            <h3 className="text-green-500 text-sm font-semibold mb-2">Aliados</h3>
          ...
          <div>
            <h3 className="text-red-500 text-sm font-semibold mb-2">Rivales</h3>
            <div className="flex flex-wrap gap-2">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          {hasVoted ? "Ya has votado" : "Votar por este personaje"}
        </Button>
      </div>
    </div>
  );
