      ...
      <section className="py-16 bg-brainrot-dark">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-8">
            ENTRA NELLA <span className="text-brainrot-turquoise">COMMUNITY</span>
          </h2>
          ...
          <div className="max-w-3xl mx-auto bg-brainrot-light p-8 rounded-lg shadow-lg">
            <h3 className="text-2xl font-bold text-white mb-4">
              {isAuthenticated 
                ...
                : "Unisciti alla community di Bombardino!"}
            </h3>
            
            <p className="text-gray-400 mb-6">
              {isAuthenticated 
                ? "Continua ad esplorare l'universo di Bombardino e non dimenticare di votare i tuoi personaggi preferiti." 
                : "Crea un account gratuito per votare i tuoi personaggi preferiti e contribuire alla community."}
            </p>
